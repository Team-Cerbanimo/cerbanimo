...
export default function OuterFooter() {
    return (
        <Navbar sticky="bottom" id="outsideFooter">
            <Row id="tableFooter">
                <Col lg={3}><img src="https://cerbanimo.quinixdesign.com/v2/wp-content/uploads/2020/11/Cerbanimo-Logo-V001-5.png" alt="Cerbanimo logo"></img> <br></br> <p>Copyright © 2020 Cerbanimo, LLC.</p></Col>
                    <Col>
